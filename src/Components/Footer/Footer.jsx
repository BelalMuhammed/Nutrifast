          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6'>
            ...
            <div className='flex items-center gap-3 sm:gap-4'>
              <div className='bg-app-accent rounded-full p-2 sm:p-3 flex-shrink-0'>
                <FaShippingFast className='text-app-primary text-lg sm:text-xl' />
              </div>
            ...
            <div className='flex items-center gap-3 sm:gap-4'>
              <div className='bg-app-accent rounded-full p-2 sm:p-3 flex-shrink-0'>
                <FaPhoneAlt className='text-app-primary text-lg sm:text-xl' />
              </div>
              <div className='min-w-0'>
                <h4 className='font-bold text-gray-900 text-sm sm:text-base'>
                  Give Us A Call
                </h4>
                <p className='text-app-primary text-xs sm:text-sm font-medium break-words'>
                  +20 123 456 7890
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center gap-3 sm:gap-4'>
              <div className='bg-app-accent rounded-full p-2 sm:p-3 flex-shrink-0'>
                <FaEnvelope className='text-app-primary text-lg sm:text-xl' />
              </div>
              <div className='min-w-0'>
                <h4 className='font-bold text-gray-900 text-sm sm:text-base'>
                  Email Us
            ...
            <div className='flex items-center gap-3 sm:gap-4'>
              <div className='bg-app-accent rounded-full p-2 sm:p-3 flex-shrink-0'>
                <FaHeart className='text-app-primary text-lg sm:text-xl' />
              </div>
              <div className='min-w-0'>
                <h4 className='font-bold text-gray-900 text-sm sm:text-base'>
                  Community
            ...
            <div>
              ...
              <div className='flex flex-wrap gap-2 sm:gap-3'>
                <a
                  ...
                  <FaFacebookF className='text-gray-600 group-hover:text-white text-base sm:text-lg' />
                </a>
                <a
                  href='#'
                  className='bg-gray-100 hover:bg-app-accent p-2 rounded-xl transition flex-shrink-0 group'>
                  <FaTwitter className='text-gray-600 group-hover:text-white text-base sm:text-lg' />
                </a>
                <a
                  href='#'
                  className='bg-gray-100 hover:bg-app-accent p-2 rounded-xl transition flex-shrink-0 group'>
                  <FaInstagram className='text-gray-600 group-hover:text-white text-base sm:text-lg' />
                </a>

                <a
                  href='#'
                  className='bg-gray-100 hover:bg-app-accent p-2 rounded-xl transition flex-shrink-0 group'>
                  <FaYoutube className='text-gray-600 group-hover:text-white text-base sm:text-lg' />
                </a>
              </div>
            </div>
          </div>
