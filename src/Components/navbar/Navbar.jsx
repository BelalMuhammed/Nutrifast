    ...
    <nav className='w-full bg-[#FFFFFF] shadow-md flex justify-between items-center px-[40px]'>
      ...
      <div className='w-[1086px] px-4 py-4 flex items-center justify-between relative'>
        ...
        <div className='hidden md:flex items-center space-x-6'>
          ...
          <Link to="/cart"><FiShoppingCart className='text-2xl text-gray-700 cursor-pointer hover:text-blue-600 transition duration-300 hover:scale-125 hover:translate-y-1' />
        </Link></div>
